...
type footerLinksFirstBlock = Array<FooterLinksArray>
type footerLinksSecondBlock = Array<FooterLinksArray>

interface FooterLinksArray {
    title: string
}

const footerLinksFirstBlock = [
    {
        title: 'О нас',
        to: '/about'
    },
