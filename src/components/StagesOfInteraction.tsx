...
import { StyledH2, StyledSpan } from "../styles/Fonts.styled";

const InformationCard: FC<{ children: ReactNode }> = ({ children }): JSX.Element => {
    return (
        <Flex
            justify={'flex-start'}
            align={'center'}
            ...
            boxShadow={'0px 1px 40px rgba(0, 0, 0, 0.07)'}
            br={'14px'}
            padding={'20px'}
            fontSize={'15px'}
        >
        ...
        >
            ...
            >
                ...
                <svg width="600" height="600" viewBox="0 0 600 600" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M308.707 49.2929C309.098 49.6834 309.098 50.3166 308.707 50.7071L302.343 57.0711C301.953 57.4616 301.319 57.4616 300.929 57.0711C300.538 56.6805 300.538 56.0474 300.929 55.6569L306.586 50L300.929 44.3431C300.538 43.9526 300.538 43.3195 300.929 42.9289C301.319 42.5384 301.953 42.5384 302.343 42.9289L308.707 49.2929ZM307.117 49H308V51H307.117V49Z" fill="#FF654E" />
                    ...
                    <path d="M300 550C363.587 550 424.784 525.77 471.137 482.242C517.49 438.714 545.514 379.159 549.507 315.698C553.499 252.236 533.16 189.638 492.628 140.644C452.097 91.6496 394.419 59.9409 331.333 51.9713" stroke="#FF654E" strokeMiterlimit="11.4737" strokeLinecap="round" strokeDasharray="6 6" />
                    <path d="M300 50C236.413 50 175.216 74.2297 128.863 117.758C82.5105 161.286 54.4859 220.841 50.4933 284.302C46.5007 347.764 66.84 410.362 107.372 459.356C147.903 508.35 205.581 540.059 268.667 548.029" stroke="#FF654E" strokeLinecap="round" strokeLinejoin="round" strokeDasharray="6 6" />
                </svg>
            </Flex>
            <Flex
                position={'absolute'}
            ...
            >
                ...
                >
                    ...
                    <InformationCard>
                        <img style={{ transform: 'scale(-1, 1)' }} width={70} height={70} src="/img/cart.png" />
                        <p style={{ margin: '0', paddingLeft: '20px' }}>
                            Поиск нужного магазина<br />
                            на нашем сайте
                        </p>
                    </InformationCard>
                    <InformationCard>
                        <img width={70} height={70} src="/img/cup.png" />
                        <p style={{ margin: '0', paddingLeft: '20px' }}>
                ...
                >
                    ...
                    <InformationCard>
                        <img width={70} height={70} src="/img/employee.png" />
                        <p style={{ margin: '0', paddingLeft: '20px' }}>
                            Постоянное отслеживание свежих предложений и их проверка
                        </p>
                    </InformationCard>
                    <InformationCard>
                        <img width={70} height={70} src="/img/magnifier.png" />
                        <p style={{ margin: '0', paddingLeft: '20px', paddingBottom: '8px' }}>
                            Обновление промокодов и<br />
                            расширение списка магазинов
                        </p>
                    </InformationCard>
                </Flex>
            </Flex>
